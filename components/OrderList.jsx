      ...
      {orders &&
        orders?.products?.map((item, index) => {
          return (
            <div
              key={index}
              className="flex items-start gap-6 dark:bg-neutral-900 shadow-md rounded-lg px-2 py-3 md:p-6"
            >
              ...
              <div className="flex flex-col w-full gap-6">
                ...
                <div className="flex whitespace-nowrap justify-between items-center">
                  ...
                  <div className="flex items-center dark:bg-neutral-700 bg-gray-100 rounded-md px-2 py-1 gap-5 font-bold">
                    <button
                      onClick={() =>
